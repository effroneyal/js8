...
{
    document.write("<h3 style='color:blue'> inside: &nbsp;" + i + "<h3/>");
     window.alert("the value of i at the beggining is:   " + i);
    if (myNum === 0)
     { 
     drawEllipse(300, 250, 400, 200, "yellow", pen, lineWidth);
       ...
       window.alert("the value of i at the end is:   " + i);
  }
 document.write("<h3 style='color:red'> outside: &nbsp;" + i + "<h3/>");